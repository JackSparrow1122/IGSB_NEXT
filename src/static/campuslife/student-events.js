  ...
  "AY-2024-25": [
    {
      title: "Vyavahar 2025",
      description: [
        `IGSB Hosted and organised "Vyavahar" a dynamic game, which challenged the students to navigate the complexities of entrepreneurship and make strategic decisions to grow virtual businesses. From managing retail stores and real estate to offering educational courses students lived different sectors.`,
    ...
    {
      title: "Start Up Sprint – Business Plan Competition for MBA",
      description: [
    ...
    {
      title: "Industrial Visit to Kalyani Maxion Wheels, Chakan",
      description: [
        `IGSB students explored the world of manufacturing excellence during an insightful industrial visit to Kalyani Maxion Wheels, Chakan.`,
        `From learning about cutting-edge production processes to understanding real-world operations, it was a day packed with practical knowledge and inspiration!`,
      ],
      images: [],
    },
    {
      title: "Splash 2024: A Cultural Extravaganza",
      description: [
        `At IGSB, we believe that education goes beyond classrooms—it’s about creating memories, fostering creativity, and celebrating diversity. Our vibrant cultural event that brought together students, faculty, and alumni for a day of unforgettable experiences!`,
    ...
    {
      title: "The Book Badshah – Thought‑Provoking Book Olympiad",
      description: [
        `On October 26, 2024, the Book Badshah - Thought Provoking Book Olympiad was organized at Indira Global School of Business (IGSB) to inspire students to explore more about literature. Aimed at developing students' critical thinking and presentation skills, the event centered around book reviews and thought-provoking discussions.`,
        `The book reviews were presented on October 21, 2024, with the competition evaluated by esteemed faculty members of IGSB. Recognizing students' dedication, the prize distribution ceremony was held on October 26, awarding top-performing groups and acknowledging the efforts of all participants with certificates.`,
    ...
    {
      title: "Chai Pe Charcha – Alumni Interaction",
      description: [
        `A session on "Chai Pe Charcha" (Alumini Interaction programme) was conducted with Mr. Devesh Maheshwari, an alumni of Indira Global School of Business 2017-19 to provide insights into the vast array of professional avenues and leading students of IGSB towards entrepreneurial success. The session aimed to equip students with a comprehensive understanding of the industry’s growth, emerging trends, and the skill sets required to thrive in their lives.`,
    ...
    {
      title: "Students Conference – Fintech for Inclusivity and Sustainability",
      description: [
        `This particular Conference was organized at IGSB with motive of promoting the students for the research activity. The conference got fabulous response of 35 students who participated and presented their research papers on the given theme “Fintech for Inclusivity and Sustainability”.`,
    ...
    {
      title: "Corporate Yodha – Unleashing the Power of Qu in You",
      description: [
    ...
    {
      title: "PoSH Orientation & Gender Sensitisation",
      description: [
        `An enlightening session by Adv. Shalini Sharma on Gender Sensitisation and PoSH Orientation conducted on 24th Jan 2025, left the students of IGSB inspired and informed!`,
    ...
    {
      title: "Empowering Students for Viksit Bharat – Artha Bodh Forum x NISM",
      description: [
        `IGSB Artha Bodh forum in collaboration with its professional partner NISM, has successfully conducted informative and interactive sessions for students on 25th Jan 2025.`,
        `It empowered students with knowledge of security market and placement and business opportunities associated with it.`,
    ...
    {
      title: "Union Budget 2025 – Live Viewing",
      description: [
        "IGSB students gained insights into India's economic roadmap and its impact on future business trends on 1st Feb 2025.",
      ],
      images: [
        `/IGSB/student-engagement/Budget_2025_live_1.webp`,
        `/IGSB/student-engagement/Budget_2025_live_2.webp`,
        `/IGSB/student-engagement/Budget_2025_live_3.webp`,
      ],
    },
    {
    ...
    {
      title: "Session on Union Budget 2025 – By Mr. Chandrashekhar Tilak",
      description: [
    ...
    },
    {
      ...
      description: [
        `IGSB had the honor of hosting Dr. Sunder Madakshira, CMO of Sinch, for an insightful workshop on 'Designing and Executing Strong Business Strategy' on 14th Feb 2025. An engaging session that equipped our students with valuable tools and frameworks to navigate the dynamic business landscape.`,
      ],
      images: [
        `/IGSB/student-engagement/Business_Strategy_1.webp`,
        `/IGSB/student-engagement/Business_Strategy_2.webp`,
        `/IGSB/student-engagement/Business_Strategy_3.webp`,
        `/IGSB/student-engagement/Business_Strategy_4.webp`,
      ],
    },
    {
      title: "Movie Club Activity – Management Through Cinema",
      description: [
    ...
    {
      title: "C4I4 Lab Visit – Industry 4.0 Orientation",
      description: [
    ...
    {
      title: "A Guest Session on Indian Knowledge Systems (IKS) & HR Functions",
      description: [
